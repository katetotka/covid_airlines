# [Covid Airlines](https://www.kaggle.com/akulbahl/covid19-airline-flight-delays-and-cancellations)
...
In this project an attempt is made to make a brief EDA of the above dataset. Through the use of the r language and some of its packages: dplyr, tidyverse, ggplot2 the following questions are answered:
1. 
